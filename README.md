# Manipulacao-dados-com-TypeScript

## Prática de manipulação de dados de uma API, tratados e exibidos no FrontEnd com TypeScript.

### O projeto consites na prática de desenvolvimento web com a linguagem TypeScript para consumo e manipulação de dados provenientes de uma API externa.
